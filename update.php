...
<!DOCTYPE html>
      ...
      <?php
            ...
            if(isset($_POST['btnUpdate'])) {
                  $cPrice = $_POST['price'];
                  $id = $_POST['id'] ;
                  $sql = "UPDATE product set price=$cPrice WHERE cid=$id";
            ...
            <div class="row col-5" style="align-items: center;margin-left: 200px;">
                ...
                <form action="" method="POST" enctype="multipart/form-data">
                    <div class="mt-2" style="align-items: center;align-content: center;">
                      ...
                      <input type="submit" name="btnEdit" value="Edit" class="btn mt-2 mx-3" style="text-align: center;background-color: #FB928E;">
                    </div>
                  ...
                  <div class="mt-2">
                              ...
                              <div class="mt-2" style="align-items: center;align-content: center;">
                                ...
                                <div class="mt-2 mb-3">
                                  <input type="submit" name="btnUpdate" value="Update" class="btn mt-2 mb-3" style="text-align: center;background-color: #FB928E;">
                                </div>
                          </div>
                  </form>
                </div>
